...
try {
    $asistencias = supabase_request("asistencia");
...
// Obtener la fecha con más asistencia
...
<body class="p-4 md:p-8">
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8 fade-in">
            <a href="registrar_nino.php" class="nav-button glass-card rounded-2xl p-6 shadow-xl text-center block">
            ...
            <a href="asistencia.php" class="nav-button glass-card rounded-2xl p-6 shadow-xl text-center block">
                <div class="text-5xl mb-3">✅</div>
